...
const SpaceChart = () => {
    ...
    const getChartOptions = (floorId) => {
        return {
            ...
            cutout: '50%',  // Doughnut-like appearance
            borderWidth: 2,
            hoverOffset: 15
        };
    };
            ...
            datasets: [
                {
                    ...
                    backgroundColor: [
                        "rgba(66, 165, 245, 0.8)",  // Softer blue
                        "rgba(239, 83, 80, 0.8)"    // Softer red
                    ],
                    borderColor: [
                        "rgba(30, 136, 229, 1)",   // Darker blue
                        "rgba(211, 47, 47, 1)"     // Darker red
                    ],
                    hoverBackgroundColor: [
                        "rgba(66, 165, 245, 1)",   // Brighter blue on hover
                        "rgba(239, 83, 80, 1)"     // Brighter red on hover
                    ]
                }
            ]
        };
