...
const ViewLightingEnergyConsumptionDetails = () => {
  ...
  return (
    <div className="lighting_energy-consumption-container">
      <h1 className="lighting_energy-title">Lighting Energy Consumption Details</h1>

      {filteredReadings.length === 0 && !loading && !error && (
        <div className="lighting_energy-no-data-message">
          No energy readings found for the Lighting category.
        </div>
      )}

      <div className="lighting_energy-filters">
        <label>
          Year:
      ...
      <table className="lighting_energy-table">
        <thead>
          <tr className="lighting_energy-header-row">
            <th>Year</th>
            <th>Month</th>
            <th>Floor</th>
            <th>Category</th>
        ...
        <tbody>
          {filteredReadings.map((reading) => (
            <tr key={reading._id}>
              ...
              <td>
                {reading.isExceeded ? (
                  <span className="lighting_energy-exceeded">Exceeded</span>
                ) : (
                  <span className="lighting_energy-normal">Normal</span>
                )}
              </td>
              <td>
                <button className="lighting_energy-edit-button" onClick={() => {
                ...
                <button className="lighting_energy-delete-button" onClick={() => handleDelete(reading._id)}>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      {editingReading && (
        <div className="lighting_energy-modal-backdrop">
          <div className="lighting_energy-modal">
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleUpdate(); }}>
              ...
              <div className="lighting_energy-button-container">
                <button className="lighting_energy-button" type="submit">Update</button>
                <button className="lighting_energy-button cancel" onClick={() => setEditingReading(null)}>Cancel</button>
              </div>
            </form>
          </div>
        </div>
